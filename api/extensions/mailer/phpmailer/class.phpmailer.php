 ...
 */
  ...
  // LIE: change this method to be public as we need to generate EML
  public function PreSend() {
    try {
      ...
      $this->SentMIMEMessage = sprintf("%s%s%s",$this->MIMEHeader,$mailHeader,$this->MIMEBody);
      return true;

    } catch (phpmailerException $e) {
      Yii::trace('exception happened during email sending...' . $e);
      $this->SetError($e->getMessage());
      if ($this->exceptions) {
        throw $e;
      }
